package com.remi.pdfscanner.customview.cropview;
...
public class PolygonView extends FrameLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawLine(pointer1.getX() + (pointer1.getWidth() / 2f), pointer1.getY() + (pointer1.getHeight() / 2f), pointer3.getX() + (pointer3.getWidth() / 2), pointer3.getY() + (pointer3.getHeight() / 2), paint);
        canvas.drawLine(pointer1.getX() + (pointer1.getWidth() / 2f), pointer1.getY() + (pointer1.getHeight() / 2f), pointer2.getX() + (pointer2.getWidth() / 2), pointer2.getY() + (pointer2.getHeight() / 2), paint);
        canvas.drawLine(pointer2.getX() + (pointer2.getWidth() / 2f), pointer2.getY() + (pointer2.getHeight() / 2f), pointer4.getX() + (pointer4.getWidth() / 2), pointer4.getY() + (pointer4.getHeight() / 2), paint);
        canvas.drawLine(pointer3.getX() + (pointer3.getWidth() / 2f), pointer3.getY() + (pointer3.getHeight() / 2f), pointer4.getX() + (pointer4.getWidth() / 2), pointer4.getY() + (pointer4.getHeight() / 2), paint);
